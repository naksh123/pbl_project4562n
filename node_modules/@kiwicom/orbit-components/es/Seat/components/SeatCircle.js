...
var StyledCircleWrapper = styled.div.withConfig({
  displayName: "SeatCircle__StyledCircleWrapper",
  componentId: "njmjdi-0"
})(["position:absolute;top:-10px;right:-10px;"]);
export var StyledCirclePath = styled.path.withConfig({
...
var SeatCircle = function SeatCircle(_ref) {
  ...
  var circleSmallId = React.useMemo(function () {
    return randomID("circleSmallId");
  }, []);
  var circleNormalId = React.useMemo(function () {
    return randomID("circleNormalId");
  }, []);
  return /*#__PURE__*/React.createElement(StyledCircleWrapper, {
    size: size
  }, size === SIZE_OPTIONS.SMALL ? /*#__PURE__*/React.createElement("svg", {
    width: "22",
    height: "22",
    viewBox: "0 0 22 22",
    fill: "none"
