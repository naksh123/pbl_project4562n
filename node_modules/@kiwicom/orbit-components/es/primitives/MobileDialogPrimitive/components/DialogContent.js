...
var StyledDialogWrapper = styled.div.withConfig({
  ...
  var theme = _ref7.theme,
      shown = _ref7.shown;
  return css(["", ",", ",", ""], transition(["transform"], "normal", "ease-in-out"), transition(["visibility"], "fast", "linear"), !shown && theme.orbit.durationNormal);
}, function (_ref8) {
...
var StyledTooltipContent = styled.div.withConfig({
  ...
  return theme.orbit.spaceMedium;
}, StyledText, Item, function (_ref19) {
  ...
  return theme.orbit.paletteWhite;
}, StyledTextLink, function (_ref22) {
...
var StyledDialogOverlay = styled.div.withConfig({
  ...
  var theme = _ref25.theme,
      shown = _ref25.shown;
  return css(["", ",", ",", ""], transition(["opacity"], "normal", "ease-in-out"), transition(["visibility"], "fast", "linear"), !shown && theme.orbit.durationNormal);
}); // $FlowFixMe: https://github.com/flow-typed/flow-typed/issues/3653#issuecomment-568539198
...
var DialogContent = function DialogContent(_ref26) {
  ...
  var handleInnerClick = React.useCallback(function (ev) {
    if (dialog.current) {
      var focusableElements = dialog.current.querySelectorAll(FOCUSABLE_ELEMENT_SELECTORS);
