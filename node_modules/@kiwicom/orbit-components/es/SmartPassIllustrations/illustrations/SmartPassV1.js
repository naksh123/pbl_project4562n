...
var SmartPassV1 = function SmartPassV1(_ref) {
  var _ref$primary = _ref.primary,
      ...
      props = _objectWithoutProperties(_ref, ["primary", "secondary"]);

  var randomIDLinear = React.useMemo(function () {
    return randomID("linear1");
  }, []);
  var randomIDLinear2 = React.useMemo(function () {
    return randomID("linear2");
  }, []);
  var randomIDLinear3 = React.useMemo(function () {
    return randomID("linear3");
  }, []);
  return /*#__PURE__*/React.createElement(IllustrationWrapper, _extends({}, props, {
