...
var getViewportGridStyles = function getViewportGridStyles(_ref) {
  ...
  return function (props) {
    if (props[viewport]) {
      ...
      return css(["", ";max-width:", ";width:", ";grid-template-columns:", ";grid-template-rows:", ";grid-column-gap:", ";grid-row-gap:", ";grid-gap:", ";", ";"], getDisplay(inline, viewport === "smallMobile"), maxWidth, width, columns, rows, columnGap, rowGap, gap, compatibleIE);
    }
