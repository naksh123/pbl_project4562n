...
var isFirst = function isFirst(value, valueNow, index, hasHistogram) {
  if (Array.isArray(value)) {
    var max = Math.max.apply(Math, (0, _toConsumableArray2.default)(value));
    var min = Math.min.apply(Math, (0, _toConsumableArray2.default)(value));
...
var StyledHandle = (0, _styledComponents.default)(function (_ref) {
  var left = _ref.left,
      theme = _ref.theme,
      onTop = _ref.onTop,
      props = (0, _objectWithoutProperties2.default)(_ref, ["left", "theme", "onTop"]);
  ...
  var left = _ref2.left,
      ...
      theme = _ref2.theme;
  return {
    style: (_style = {}, (0, _defineProperty2.default)(_style, (0, _rtl.left)({
      theme: theme
    }), "calc(".concat(left, "% - 12px)")), (0, _defineProperty2.default)(_style, "zIndex", onTop ? 20 : undefined), _style)
  };
}).withConfig({
...
}, (0, _transition.default)(["box-shadow"], "fast", "ease-in-out"), function (_ref5) {
