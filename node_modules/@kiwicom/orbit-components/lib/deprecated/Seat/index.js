...
var getSize = function getSize(_ref) {
  ...
  var size = _ref.size;
  var tokens = (_tokens = {}, (0, _defineProperty2.default)(_tokens, _consts.SIZE_OPTIONS.SMALL, "20px"), (0, _defineProperty2.default)(_tokens, _consts.SIZE_OPTIONS.MEDIUM, "40px"), _tokens);
  return "width: ".concat(tokens[size], "; height: ").concat(tokens[size], ";");
};

var StyledSeat = _styledComponents.default.svg.withConfig({
  displayName: "Seat__StyledSeat",
  componentId: "sc-16nui1c-0"
})(["flex-shrink:0;", ";"], getSize);

var SeatType = function SeatType(_ref2) {
  var type = _ref2.type;
  var theme = (0, _useTheme.default)();

  switch (type) {
    case _consts.TYPES.LEGROOM:
    ...
    case _consts.TYPES.UNAVAILABLE:
      return /*#__PURE__*/React.createElement("g", {
        fill: "none",
        fillRule: "nonzero"
      }, /*#__PURE__*/React.createElement("path", {
...
var Seat = function Seat(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(StyledSeat, {
    preserveAspectRatio: "xMidYMid meet",
    viewBox: "0 0 40 40",
    size: size,
    "data-test": dataTest
  }, /*#__PURE__*/React.createElement(SeatType, {
    type: type
  }));
};
